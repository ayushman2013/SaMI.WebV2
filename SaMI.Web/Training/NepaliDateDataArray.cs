...
namespace SaMI.Web.Training
{
    public static class NepaliDateDataArray
    {
        ...
        public static int[] GetNepaliDateDataArray(int year)
        {
            ...
            {
                case 1945:
                    return new int[15] { 2001, 18, 30, 29, 30, 30, 31, 31, 32, 31, 31, 31, 30, 29, 30 };

                case 1946:
                    return new int[15] { 2002, 18, 30, 29, 30, 30, 31, 31, 32, 32, 31, 30, 30, 29, 30 };

                case 1947:
                    return new int[15] { 2003, 17, 29, 29, 30, 30, 31, 32, 31, 32, 31, 30, 30, 30, 29 };

                case 1948:
                    return new int[15] { 2004, 17, 29, 30, 29, 31, 30, 32, 31, 32, 31, 30, 30, 30, 29 };
